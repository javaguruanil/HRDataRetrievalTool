	...
	public ResponseEntity<?> sendMail(@RequestBody Map<String, Object> requestMap) throws Exception{
		...
		try {
			...
			MailSender.sendEmail(emailAccount.getAdminemail(), emailAccount.getAdminpassword(),
				emailId, null, mailSubject,
				"Thank you for using this tool for generating test data.", dataList);
			...
			ResponseEntity<String> res=new ResponseEntity<String>(jsonObj.toString(),HttpStatus.INTERNAL_SERVER_ERROR);
			return res;
		}
